...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/kk/instruct/8ppl')
    parser.add_argument('--data_path', default='/export/fs06/fyang62/huggingface/hub/datasets--K-and-K--knights-and-knaves/snapshots/2f68547989981b1af37cb3dde5fdefa847aa8619/train/people8_num1000.jsonl')
